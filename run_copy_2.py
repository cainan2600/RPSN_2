...
from lib.plot import plot_IK_solution, plot_train
...
class main():
    ...
    def train(self):
            ...
            for data_test in data_loader_test:
                with torch.no_grad():
                    ...
                    for i in range(len(inputs_test)):
                        ...
                        IK_loss_test, IK_loss_test_incorrect, IK_loss_test_correct = IK_loss.calculate_IK_loss_test(angle_solution, inputs_test[i], outputs_test[i])
                        # 计算IK_loss时存在的错误
        ...
        # 画图
        plot_IK_solution(1 , epochs, self.args.num_train, NUM_incorrect_test, NUM_correct_test)
        plot_train(1, epochs, self.args.num_train, NUMError1, NUMError2, NUMNOError1, NUMNOError2)
